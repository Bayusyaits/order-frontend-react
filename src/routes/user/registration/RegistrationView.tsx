...
function RegistrationView({ handleSubmit, handleRegistration, errors, register, isDisabled }: ViewProps) {
  return (
            ...
            <div className='intro-x mt-8'>
              <div className={`input-form ${errors.username?.message ? 'has-error' : ''}`}>
                <input
                  ...
                  name='username'
                  type='text'
                  className='intro-x registration__input form-control py-3 px-4 border-gray-300 block'
              ...
              <div className={`input-form ${errors.password?.message ? 'has-error' : ''}`}>
                <input
                  ...
                  name='password'
                  type='password'
                  className='intro-x registration__input form-control py-3 px-4 border-gray-300 block mt-4'
